...
public class HammerItem : ToolItem
{
    ...
    private InteractResult TryPickUp(WorldObject obj, InteractionContext context)
    {
        ...
        // TODO (Marjie): Use the PropertyManager API to do this after merging this into master
        var authComponent = obj.GetComponent<AuthComponent>();
        if (authComponent != null && authComponent.AuthController != null)
        {
            Result authResult = authComponent.AuthController.IsAuthorized(context.Player.User);
