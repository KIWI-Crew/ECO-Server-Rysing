  ...
  (factory((global.ECO = global.ECO || {})));
	...
	function GIFDECODER(name, OnFinish) {
	    ...
	    var doComment = function (cblock) {
	        GIFMANAGER.gifTimes[my.parseName].push(parseFloat(cblock.comment));
	    };
	...
	PlotMap.prototype.SetPixel = function (vec, size) {
		size = size || 1;
	...
	PlotMap.prototype.DrawLine = function (start, end, size) {
		size = size || 1;
	...
	var MINIMAP = (function () {
	    ...
	    var terrainmap = new THREE.TextureLoader().load('Layers/Terrain.gif');
	    ...
	    my.setLayer = function (layerName, viewRef) {
	    ...
	    my.fillLayerSelects = function (sell) {
	    	sell = sell || false;
	        var layerSelected = '';
	        if (sell) {
